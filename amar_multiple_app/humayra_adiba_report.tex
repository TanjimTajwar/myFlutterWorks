...
\begin{center}
    ...
    \textbf{Device Testing:} Real Android Phone (Wireless Debugging)\\[1.2cm]

    % Instructor Section
    \textbf{Submitted To:}\\[6pt]
    Prof. Dr. Mohammad Osiur Rahman\\
    Professor, Computer Science \& Engineering\\
    University of Chittagong, Chattogram-4331\\[1.2cm]
...
\subsection{Pairing and connection}
...
We can pair  by scanning QR code through our phone from Android studio.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{Mobile Apps Development CSE 618/images_mobile_app/Adiba.jpeg}
\caption{Phone Screen Display Showing Hello Adiba}
\end{figure}
